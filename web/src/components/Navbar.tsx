    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <Link href="/" className="group flex items-center gap-2 text-xl font-bold tracking-tighter">
          <div className="p-2 bg-white/10 rounded-lg group-hover:bg-[var(--color-accent)] transition-colors duration-300">
            <Camera className="w-5 h-5 text-white group-hover:text-black" />
          </div>
          <span className="text-white uppercase tracking-[0.2em] text-sm md:text-base">
            Cinematic<span className="font-light opacity-60">Studio</span>
          </span>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <Link 
              key={link.name} 
              href={link.href} 
              className="relative text-xs uppercase tracking-widest text-white/70 hover:text-white transition-colors group"
            >
              {link.name}
          ...
          <div className="relative group">
            <button className="flex items-center gap-1 text-xs uppercase tracking-widest text-white/70 group-hover:text-white transition-colors">
          ...
          <a
            ...
            className="px-6 py-2.5 text-[11px] uppercase tracking-[0.15em] font-bold rounded-full bg-white text-black hover:bg-[var(--color-accent)] transition-colors"
          >
            Book Now
          </a>
        </nav>
